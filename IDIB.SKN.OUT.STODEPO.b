...
* <Rating>-20</Rating>
*-----------------------------------------------------------------------------
*Created by Fike Inda Gunawan
*Date: 01/03/2011
*Routine for SKN Out STO dan DEPOSITS
*-----------------------------------------------------------------------------
*Modified by Fike Inda Gunawan
*Date: 24/03/2011
*Add facility for RTGS DEPOSITS
*-----------------------------------------------------------------------------
*Modified by Gustino
*Date: 02/08/2012
*Change AZ to MM
...
*Modified by Gustino
*Date: 19/10/2012
*Adding break deposito to be included in outgoing clearing
*Excluding STO
*-----------------------------------------------------------------------------
*Modified by Fatkhur
*Date: 04/09/2014
*Use break amount in calc for break deposito
*-----------------------------------------------------------------------------
*Modified by Yusi Almas Ghaissani
*Date: 20/03/2015
*Add facility for SKN NG
*-----------------------------------------------------------------------------
*Modified by Fatkhur Rohman
*Date: 08/06/2015
*convert multivalue Street
*-----------------------------------------------------------------------------
*Modified by Fatkhur
*Date: 20150914
*RTGS GEN 2; change field receiver bank in MM from RTGS.CODE.G2 to RTGS.BANK.G2
*    change logic set SEN.REC.INFO
*-----------------------------------------------------------------------------
* Date               : 20161128
* Modified by        : Dwi K
* Description        : change mapping DB.NAME from MUD.PRINTED.NAM to ATI.JOINT.NAME
* No Log             : CR join deposito
*-----------------------------------------------------------------------------
* Date               : 20170620
* Modified by        : Yudistia Adnan Putri
* Description        : add logic form mapping DB.NAME
* No Log             : CR join deposito
*-----------------------------------------------------------------------------
* Date               : 20181003
* Modified by        : Hamka Ardyansah
* Description        : add logic for deposito aro/non aro with condition periode.rsd eq maturity
* No Log             : Funding 3 - EF 17
*-----------------------------------------------------------------------------
* Date               : 20201124
* Modified by        : Ratih Purwaning Utami
* Description        : update amount chg (cr break depo)
* No Log             : 
*-----------------------------------------------------------------------------
* Date               : 20221003
* Modified by        : Ratih Purwaning Utami
* Description        : Penambahan biaya materai
* No Log             : 
*-----------------------------------------------------------------------------
* Date               : 20221028
...
*-----------------------------------------------------------------------------
    ...
    SUBROUTINE IDIB.SKN.OUT.STODEPO(SEL.LIST)
    ...
    $INSERT I_IDIB.SKN.OUT.STODEPO.COMMON
...
*20201124
    ...
    *Y.CHG.AMT      = ""
    ...
    Y.MATURITY.RSD = ""	;*R.AA.TERM.AMOUNT<AA.AMT.LOCAL.REF, Y.MATURITY.RSD.POS>
