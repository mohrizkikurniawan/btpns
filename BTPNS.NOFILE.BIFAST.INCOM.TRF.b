*-----------------------------------------------------------------------------------
	SUBROUTINE BTPNS.NOFILE.BIFAST.INCOM.TRF(ENQ.DATA)
*-----------------------------------------------------------------------------------
* Author	: Kania Lydia
...
*-----------------------------------------------------------------------------
	...
	FIND "@ID" IN Y.INPUT<2> SETTING Y.AF,Y.AV THEN
        Y.REF.ID = Y.INPUT<4, Y.AV>
    END
...
*-----------------------------------------------------------------------------
	...
	SHORT.TITLE		= R.ACCOUNT<AC.SHORT.TITLE
	WORKING.BALANCE	= R.ACCOUNT<AC.WORKING.BALANCE>
	
	Y.OUTPUT	= ACCOUNT.NO
	Y.OUTPUT	:= "|" :CATEGORY
	Y.OUTPUT	:= "|" :SHORT.TITLE
	Y.OUTPUT	:= "|" :WORKING.BALANCE
